...
Terrain::Terrain()
{
	...
	material->SetDiffuseMap(L"Textures/Landscape/Seamless_asphalt_v1.tga");
	...
	heightMap = Texture::Add(L"Textures/HeightMaps/dark2.png");
...
bool Terrain::ComputePicking(OUT Vector3* position)
{
	...
	const UINT x = ceil(static_cast<float>(size) / 1024.0f);
