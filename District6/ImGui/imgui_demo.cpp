...
// will want to refer to and call. Have the ImGui::ShowDemoWindow() function wired in an always-available debug menu_back of
...
void ImGui::ShowUserGuide()
{
    ...
    ImGui::BulletText("Alt to jump to the menu_back layer of a window.");
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // Examples Apps (accessible from the "Examples" menu_back)
    ...
    // Dear ImGui Apps (accessible from the "Tools" menu_back)
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        {
            ImGui::MenuItem("Main menu_back bar", NULL, &show_app_main_menu_bar);
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Examples\" menu_back above leads to more demo contents.");
        ImGui::BulletText("The \"Tools\" menu_back above gives access to: About Box, Style Editor,\n"
    ...
    if (ImGui::CollapsingHeader("Window options"))
    {
        ...
        ImGui::Checkbox("No menu_back", &no_menu);
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::SameLine(); HelpMarker("SetColorEditOptions() is designed to allow you to set boot-time default.\nWe don't have Push/Pop functions because you can force options on a per-widget basis if needed, and the user can change non-forced ones with the options menu_back.\nWe don't have a getter to avoid encouraging you to persistently save values that aren't forward-compatible.");
    ...
    if (ImGui::TreeNode("Querying Status (Active/Focused/Hovered etc.)"))
    {
        ...
        if (item_type == 9) { ret = ImGui::MenuItem("ITEM: MenuItem"); }                                // Testing menu_back item (they use ImGuiButtonFlags_PressedOnRelease button policy)
        ...
        // This is useful in particular if you want to create a context menu_back (with BeginPopupContextItem) associated to the title bar of a window.
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("We expose this for testing because scrolling sometimes had issues with window decoration such as menu_back-bars.");
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Popups"))
    {
        ...
        // Showing a menu_back with toggles
        ...
        if (ImGui::BeginPopup("my_toggle_popup"))
        {
            ...
            if (ImGui::BeginMenu("Sub-menu_back"))
            {
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        if (ImGui::BeginPopupContextItem("item context menu_back"))
        {
        ...
        ImGui::OpenPopupOnItemClick("item context menu_back", 1);
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            if (ImGui::BeginMenuBar())
            {
                ...
                {
                    if (ImGui::MenuItem("Dummy menu_back item")) {}
                    ImGui::EndMenu();
                }
                ImGui::EndMenuBar();
            }
    ...
    {
        ImGui::TextWrapped("Below we are testing adding menu_back items to a regular window. It's rather unusual but should work!");
        ImGui::Separator();
        // NB: As a quirk in this very specific example, we want to differentiate the parent of this menu_back from the parent of the various popup menus above.
        // To do so we are encloding the items in a PushID()/PopID() block to make them two different menusets. If we don't, opening any popup above and hovering our menu_back here
        // would open it. This is because once a menu_back is active, we allow to switch to a sibling menu_back by just hovering on it, which is the desired behavior for regular menus.
        ImGui::PushID("foo");
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            HelpMarker("In the color list:\nLeft-click on colored square to open color picker,\nRight-click to open edit options menu_back.");
...
// Demonstrate creating a "main" fullscreen menu_back bar and populating it.
// Note the difference between BeginMainMenuBar() and BeginMenuBar():
// - BeginMenuBar() = menu_back-bar inside current window we Begin()-ed into (the window needs the ImGuiWindowFlags_MenuBar flag)
// - BeginMainMenuBar() = helper to create menu_back-bar-sized window at the top of the main viewport + call BeginMenuBar() into it.
static void ShowExampleAppMainMenuBar()
{
...
static void ShowExampleMenuFile()
{
    ImGui::MenuItem("(dummy menu_back)", NULL, false, false);
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // Here we create a context menu_back only available from the title bar.
        if (ImGui::BeginPopupContextItem())
        {
...
// Demonstrate creating a simple static window with no decoration + a context-menu_back to choose which corner of the screen to use.
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
...
struct MyDocument
{
    ...
    // Display context menu_back for the Document
